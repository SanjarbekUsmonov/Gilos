<template>
  <div>
    <div class="info-text text-h5 text-weight-medium">sasasasasasas</div>
    ...
    <div class="info-amount">
      <div class="q-mt-lg text-h6"><b>Miqdor:</b></div>
      <div
      ...
      <div class="info-amount-cost q-mt-lg text-h6">Narx: 50000 so'm</div>
      <div class="info-amount-cost-active text-grey-8">
        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Facilis, quos
        ipsa dolor quam enim quod!
      </div>
    </div>
